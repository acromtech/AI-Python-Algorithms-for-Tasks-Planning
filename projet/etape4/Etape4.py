...
class Etape4 :
    ...
    if __name__ == '__main__':
        ...
        solver = SolverCSP(tg, 3)   # Instance du solver CSP avec le graphe et le nombre de couleurs souhaité
        solver.solve(True)          # Résolution du problème (complet=True pour obtenir toutes les solutions)
        ...
        #    TEST 8 : jean.col avec 9 couleurs // TROP LONG
